...
<div
className="
absolute bottom-[15px] right-4 md:hidden
flex items-center
h-[40px] w-[40px]
rounded-full
bg-[#2f3e4f]
...
{/* CONTENT */}
<div className="w-full md:w-[42%] bg-[#aeb9c8] px-[16px] py-[18px] md:p-12 relative flex flex-col justify-center">
...
{/* DESCRIPTION */}
<p className="hidden md:block font-[Poppins] text-[15px] text-gray-700 mb-8">
