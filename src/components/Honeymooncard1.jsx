...
<span className="absolute left-[46px] whitespace-nowrap text-[12px] font-semibold opacity-0 transform translate-x-[-8px] transition-all duration-[650ms] delay-[40ms] group-hover:opacity-100 group-hover:translate-x-0">
READ MORE
</span>
...
<span className="absolute left-[52px] whitespace-nowrap text-[13px] font-semibold opacity-0 transform translate-x-[-10px] transition-all duration-[650ms] delay-[40ms] group-hover:opacity-100 group-hover:translate-x-0">
READ MORE
</span>
